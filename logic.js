document.addEventListener('DOMContentLoaded', () => {
            ...
            // Ensure hero video is playing and unmuted by default, with autoplay fallback
            if (heroBackground) {
                try {
                    ...
                    if (playPromise && typeof playPromise.then === 'function') {
                        playPromise.catch(() => {
                            // Retry autoplay muted, then unmute on first interaction
                            heroBackground.muted = true;
                            // Notify UI listeners that mute state changed
